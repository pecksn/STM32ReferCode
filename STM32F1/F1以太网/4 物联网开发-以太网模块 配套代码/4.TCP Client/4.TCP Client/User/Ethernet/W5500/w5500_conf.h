...
/*
 * 通过宏定义选择目标开发板
 * STM32F103ZET6 -> ISO-V3开发板
 * STM32F103VET6 -> ISO-MINI-V3开发板
 */
/*使用ISO-V3开发板*/
...
#ifdef  STM32F103ZET6 
  #define WIZ_SPIx_SCS          GPIO_Pin_10						   	  /* 定义W5500的片选管脚          */
  #define WIZ_SPIx_SCS_PORT     GPIOD									   	  /* GPIO端口                     */
  #define WIZ_SPIx_SCS_CLK      RCC_APB2Periph_GPIOD	   	  /* GPIO端口时钟                 */
   
	#define WIZ_RESET             GPIO_Pin_8									/* 定义W5500的RESET管脚         */
  #define WIZ_SPIx_RESET_PORT   GPIOD 								   	  /* GPIO端口                     */
  #define WIZ_SPIx_RESET_CLK    RCC_APB2Periph_GPIOD	  	  /* GPIO端口时钟                 */
  
	#define WIZ_INT               GPIO_Pin_9									/* 定义W5500的INT管脚           */
  #define WIZ_SPIx_INT_PORT     GPIOD									  	  /* GPIO端口                     */
  #define WIZ_SPIx_INT_CLK      RCC_APB2Periph_GPIOD		    /* GPIO端口时钟                 */
#endif
