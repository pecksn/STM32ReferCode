...
/* ============================== 步进电机PWM中断回调函数 ============================== */
int Motor1_PWM_num = 0;
int Motor2_PWM_num = 0;
int Motor3_PWM_num = 0;
int Motor4_PWM_num = 0;

int Motor5_PWM_num = 0;
int Motor6_PWM_num = 0;
int Motor7_PWM_num = 0;
int Motor8_PWM_num = 0;

int road_PWM_num=6400*3;
...
void HAL_TIM_PWM_PulseFinishedCallback(TIM_HandleTypeDef *htim)
{
	...
	if(htim->Instance == htim3.Instance){
		...
		{
			Motor5_PWM_num ++;
			if(Motor5_PWM_num >= road_PWM_num)
			{
				Motor5_PWM_num = 0;
		...
		{
			Motor6_PWM_num ++;
			if(Motor6_PWM_num >= road_PWM_num)
			{
				Motor6_PWM_num = 0;
		...
		{
			Motor7_PWM_num ++;
			if(Motor7_PWM_num >= road_PWM_num)
			{
				Motor7_PWM_num = 0;
		...
		{
			Motor8_PWM_num ++;
			if(Motor8_PWM_num >= road_PWM_num)
			{
				Motor8_PWM_num = 0;
