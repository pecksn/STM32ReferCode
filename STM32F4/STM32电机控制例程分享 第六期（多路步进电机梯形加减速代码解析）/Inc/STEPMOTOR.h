...
#define STEPMOTOR_Z_DIR_PORT                  GPIOF                            // 对应STEPMOTOR的DIR+（控制器使用共阴接法）
#define STEPMOTOR_Z_DIR_PIN                   GPIO_PIN_1                      // 而DIR-直接接开发板的GND

#define STEPMOTOR_Z_ENA_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOF_CLK_ENABLE()     // 电机使能控制，如果悬空不接默认使能电机
#define STEPMOTOR_Z_ENA_PORT                  GPIOF                            // 对应STEPMOTOR的ENA+（控制器使用共阴接法）
#define STEPMOTOR_Z_ENA_PIN                   GPIO_PIN_2                      // 而ENA-直接开发板的GND 
...
#define STEPMOTOR_R_DIR_PORT                  GPIOC                            // 对应STEPMOTOR的DIR+（控制器使用共阴接法）
#define STEPMOTOR_R_DIR_PIN                   GPIO_PIN_8                       // 而DIR-直接接开发板的GND

#define STEPMOTOR_R_ENA_GPIO_CLK_ENABLE()     __HAL_RCC_GPIOH_CLK_ENABLE()     // 电机使能控制，如果悬空不接默认使能电机
#define STEPMOTOR_R_ENA_PORT                  GPIOH                            // 对应STEPMOTOR的ENA+（控制器使用共阴接法）
#define STEPMOTOR_R_ENA_PIN                   GPIO_PIN_7                       // 而ENA-直接开发板的GND 
